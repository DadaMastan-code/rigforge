...
function Row({ quotes }: { quotes: QuoteMap }) {
  return (
...
export function TickerBar() {
  ...
  return (
    <div
      id="ticker"
      className="marquee-pause relative overflow-hidden border-y border-white/5 bg-ink-900/40 py-2.5 backdrop-blur"
    >
